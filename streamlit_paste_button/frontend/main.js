...
function onRender(event) {
    ...
    if (!window.rendered) {
    // Keep iframe background transparent so parent app styles are visible
    ...
    document.body.style.margin = '0';
        ...
        pasteButton.style.height = '48px';
        pasteButton.style.minHeight = '48px';
        pasteButton.style.padding = '10px 14px';
        pasteButton.style.fontSize = '14px';
        pasteButton.style.fontWeight = '600';
        pasteButton.style.lineHeight = '1.2';
        pasteButton.style.borderRadius = '10px';
        pasteButton.style.border = '1px solid rgba(0, 0, 0, 0.12)';
        pasteButton.style.position = 'relative';
...
//        };
  ...
  window.requestAnimationFrame(() => Streamlit.setFrameHeight(56));
}
